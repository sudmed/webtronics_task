...
Сборка исходного кода происходит в зависимости от языка программирования и особенности продукта путем компилляции в бинарный файл, упаковки в бандл, архив или другой артефакт. Например, для языка Go артефактом сборки будет бинарный файл, полученный в результате выполнения команды `go build`.  
